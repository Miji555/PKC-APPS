...
export const Header: React.FC = () => {
  return (
    <div className="mb-8 flex flex-col items-center text-center pt-8 relative">
      <div className="mb-6 h-28 w-28 liquid-glass rounded-[2.5rem] flex items-center justify-center relative group transition-all duration-500 hover:scale-105 shadow-[0_15px_40px_-10px_rgba(0,0,0,0.1)] edge-shine">
         {/* Removed the inner gradient div as liquid-glass already provides a sophisticated effect */}
